                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Pharmaceutical Companies Table</h4>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a class="dropdown-item"
                                                                       href="{{ route('admin.pharmaceuticalCompanies.edit', $pharmaceuticalCompany->id) }}">Edit</a>
                                                                    <form action="{{ route('admin.pharmaceuticalCompanies.delete', $pharmaceuticalCompany->id) }}"

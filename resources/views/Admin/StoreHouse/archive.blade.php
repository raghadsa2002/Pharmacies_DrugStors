...
<head>
    ...
    <title>Store House Archive Table</title>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Store House Archive Table</h4>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.storeHouse.restore', $storeHouse->id) }}">Restore</a>
                                                                    <form
                                                                        action="{{ route('admin.storeHouse.force.delete', $storeHouse->id) }}"

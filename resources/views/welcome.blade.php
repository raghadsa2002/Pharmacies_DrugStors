...
<body>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="shop-single.html"> <img src="{{asset('WebsiteAssets/images/product_03.png')}}" alt="Image"></a>
          ...
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            ...
            <a href="shop-single.html"> <img src="{{asset('WebsiteAssets/images/product_04.png')}}" alt="Image"></a>
            <h3 class="text-dark"><a href="shop-single.html">Cetyl Pure</a></h3>
            <p class="price"><del>45.00</del> &mdash; $20.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="shop-single.html"> <img src="{{asset('WebsiteAssets/images/product_05.png')}}" alt="Image"></a>
            <h3 class="text-dark"><a href="shop-single.html">CLA Core</a></h3>
            <p class="price">$38.00</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <span class="tag">Sale</span>
            <a href="shop-single.html"> <img src="{{asset('WebsiteAssets/images/product_06.png')}}" alt="Image"></a>
        ...
        <div class="row">
          <div class="col-md-12 block-3 products-wrap">
            <div class="nonloop-block-3 no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{asset('WebsiteAssets/images/person_1.jpg')}}" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{asset('WebsiteAssets/images/person_2.jpg')}}" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{asset('WebsiteAssets/images/person_3.jpg')}}" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                  <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis voluptatem consectetur quam tempore
                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur ducimus. Minus ratione sit quaerat
                    unde.&rdquo;</p>
                </blockquote>
              ...
              <div class="testimony">
                <blockquote>
                  <img src="{{asset('WebsiteAssets/images/person_4.jpg')}}" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                  <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis voluptatem consectetur quam tempore
                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur ducimus. Minus ratione sit quaerat
                    unde.&rdquo;</p>
                </blockquote>
  ...
  <script src="{{asset('WebsiteAssets/js/jquery-3.3.1.min.js')}}"></script>
  <script src="{{asset('WebsiteAssets/js/jquery-ui.js')}}"></script>
